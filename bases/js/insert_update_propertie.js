    ...
    else if ($("#client_number").val() === "") 
    {
      ...
      $.ajax({
        ...
        data: {
          ...
          property_value_rateio: $("#property_value_rateio").val(),
          property_value_seguro: $("#property_value_seguro").val(),
          property_value_sabesp: $("#property_value_sabesp").val(),
          property_value_comgas: $("#property_value_comgas").val(),
