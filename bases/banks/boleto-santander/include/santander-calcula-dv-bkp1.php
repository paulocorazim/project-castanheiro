...
$fator_vencimento 		= fator_vencimento( $_REQUEST['vencimento'] );

//valor tem 10 digitos, sem virgula
$valor 					= formata_numero( $_REQUEST['valor_boleto'], 10, 0, "valor" );

//Modalidade Carteira
$carteira 				= $_REQUEST['carteira'];

//codigocedente deve possuir 7 caracteres
$codigocliente 			= formata_numero( $_REQUEST['cedente'], 7, 0 );

//nosso numero (sem dv)  11 digitos
$nnum = formata_numero( $_REQUEST['nbol'], 7, 0 );
