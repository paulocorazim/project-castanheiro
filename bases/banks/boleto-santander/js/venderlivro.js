function valida_campos3(){
	...
	if(document.form_formapag.x_preco.value<="0" || document.form_formapag.x_preco.value==""){
		alert("Erro! O valor do livro não foi informado");
		document.form_formapag.x_preco.focus();
		return false;	
	}
