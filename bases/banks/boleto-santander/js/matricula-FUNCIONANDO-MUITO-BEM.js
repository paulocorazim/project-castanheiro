function valida_campos3(){
	...
	if(y_formapg=="CCV" && y_qtdparc>6){
		alert("Erro! Cartão Crédito Visa - Pagamento no máximo em 06 (seis) parcelas.");
		document.form_formapag.x_qtdparc.focus();
		return false;
	}

	if(y_formapg=="CCM" && y_qtdparc>6){
		alert("Erro! Cartão Crédito Master - Pagamento no máximo em 06 (seis) parcelas.");
		document.form_formapag.x_qtdparc.focus();
		return false;
	}

	if(y_formapg=="CCH" && y_qtdparc>6){
		alert("Erro! Cartão Crédito Hiper - Pagamento no máximo em 06 (seis) parcelas.");
		document.form_formapag.x_qtdparc.focus();
		return false;
	}

	if(y_formapg=="CDV" && y_qtdparc>1){
		alert("Erro! Cartão Débito Visa - Pagamento em apenas 01 (uma) parcela.");
		document.form_formapag.x_qtdparc.focus();
		return false;
	}
	
	if(y_formapg=="CDM" && y_qtdparc>1){
		alert("Erro! Cartão Débito Master - Pagamento em apenas 01 (uma) parcela.");
		document.form_formapag.x_qtdparc.focus();
		return false;
	}
