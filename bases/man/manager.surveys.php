<?php /** @noinspection DuplicatedCode */
    ...
    include("../class/class.ScreenSurvey.php"); // aqui importamos a tela
    ...
    //Conteudo
    $screenSurvey = new ScreenSurveys(); // aqui estanciamos a tela
    ...
    if ($_GET['report'] === 'true') {
        ...
        $contentNow = $screenSurveys->screenSurvey(); // aqui atribuimos o contenNow com o form desejado
    ...
    $contentNow = $screenSurvey->screenSurvey(); // aqui atribuimos o contenNow com o form desejado
    $screenManager = new ScreenManager();
